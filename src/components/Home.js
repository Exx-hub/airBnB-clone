		...
		<div className="home">
			...
			<div className="home__section">
				<Card
					...
					text="Superhost with a stunning view of the beachside in Sunny Bournemouth"
					price="$130/night"
				/>
				<Card
					image="https://thespaces.com/wp-content/uploads/2017/08/Courtesy-of-Airbnb.jpg"
					title="Penthouse in London"
					text="Enjoy the amazing sights of London with this stunning penthouse"
					price="$350/night"
				/>
				<Card
					image="https://media.nomadicmatt.com/2018/apartment.jpg"
					title="1 Bedroom apartment"
					text="Superhost with great amenities and a fabolous shopping complex nearby"
					price="$70/night"
				/>
			</div>
		</div>
