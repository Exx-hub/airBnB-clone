	...
	return (
		<div className="searchPage">
			<div className="searchPage__info">
				<p>62 stays · 3 october to 10 october · 2 guests</p>
				<h1>Stays Nearby</h1>
			...
			<div className="searchPage__cards">
				...
				<SearchCard
					...
					location="Private room in center of London"
					title="5 rating Luxury Apartment"
					features="3 guest · 1 bedroom · 1 bed · 1.5 shared bthrooms · Wifi · Kitchen · Free parking · Washing Machine"
					rating={3.85}
					price="$90 / night"
					total="$650 total"
				/>
